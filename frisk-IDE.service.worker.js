...
/** @type {string} */
const CACHE_VERSION = '1776553285|123079289';
/** @type {string} */
const CACHE_PREFIX = 'frisk-IDE-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'frisk-IDE.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["frisk-IDE.html","frisk-IDE.js","frisk-IDE.offline.html","frisk-IDE.icon.png","frisk-IDE.apple-touch-icon.png","frisk-IDE.audio.worklet.js","frisk-IDE.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["frisk-IDE.wasm","frisk-IDE.pck"];
